...
class Plot {
    ...
    public inline static function plotCubicBezierSegAA( pixels:     TPixels
                                                    ,   x0: Int,    y0: Int
                                                    ,   x1: Float,  y1: Float
                                                    ,   x2: Float,  y2: Float
                                                    ,   x3: Float,  y3: Float
    ...
    public inline static function plotLineWidth(    pixels: TPixels
                                                ,   x0: Int, y0: Int
                                                ,   x1: Int, y1: Int
                                                ,   wd: Float
                                                ,   col: Int, alpha: Int ){
...
//
    public inline static function plotQuadSpline( pixels: TPixels
                                                , n: Int
    ...
    public inline static function plotCubicSpline(  pixels:         TPixels
                                                ,   n: Int
                                                ,   x: Array<Int>,  y: Array<Int>
                                                ,   col: Int,       alpha: Int ) {
        var M_MAX: Int = 6;
